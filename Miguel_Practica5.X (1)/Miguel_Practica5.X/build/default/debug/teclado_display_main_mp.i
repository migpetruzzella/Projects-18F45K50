...
# 10 "teclado_display_main_mp.c" 2
...
const char segmentos[]={0x24,0xc7,0xe5,0x74,0xf1,0xf3,0xa4,0xf7,0xf4,0xb7,0xb7,0x40,0xa5,0xd6,0xe5,0x65};
...
# 19 "teclado_display_main_mp.c" 2
...
char p_imp;
char p_par;
# 20 "teclado_display_main_mp.c" 2
        ...
        if(INTCONbits.TMR0IF){
            ...
            switch(rota){
                ...
                case 2:
                    ...
                    if ((PORTDbits.RD2==1 & 0x0F)!=0){

                        tecla=8;
                    }
                    if ((PORTDbits.RD3==1 & 0x0F)!=0){
                ...
                case 4:
                    ...
                    if ((PORTDbits.RD0==1 & 0x0F)!=0){

                        tecla=3;
                    }
                    if ((PORTDbits.RD1==1 & 0x0F)!=0){
