...
const char segmentos[]={0x24,0xc7,0xe5,0x74,0xf1,0xf3,0xa4,0xf7,0xf4,0xb7,0x40,0xd3,0x42,0x48,0xf6,0xf7,0x93};
...
void dis_cerrado(){
 ...
 void verificacion(){
     ...
     if(contador_de_lectura>5){
            ...
            if(byte_de_verif==codigo_leido[5] && estado==1 && codigo_leido[0]== 01){
                weeprom(codigo_leido[0],codigo_leido[1]);
                ...
                if(byte_de_verif==codigo_leido[5] && estado==1 && codigo_leido[0]== 02){
                weeprom(codigo_leido[0]+0x02,codigo_leido[1]);
