...
const char segmentos[]={0x12,0xc7,0xd3,0x72,0xf1,0xf5,0x13,0xf7,0xf3,0xb7,0x77,0xf4,0xa5,0xd6,0xe5,0x65};
char codigo_leido[5];
char rx_buf;
...
void __attribute__((picinterrupt(("high_priority")))) hint(void)
{
        ...
        if(PIR1bits.RCIF){
            ...
            char *puntero_codigo = codigo_leido;

            tx_232(puntero_codigo[0]);
